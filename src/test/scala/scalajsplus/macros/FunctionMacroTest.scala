package scalajsplus.macros

import scala.scalajs.js
import scala.scalajs.js.JSON
import scalajsplus.{BaseTest, OptDefault, OptionalParam}
...
//    ab.asInstanceOf[js.Any]
  ...
  def SeqUndefTest(
      s: OptionalParam[Seq[String]] = Seq("dude"),
      as: OptionalParam[Seq[Address]] = Seq(Address("India"), null))
    : js.Object = {
    val p = FunctionObjectMacro()
    p
  }
  ...
  def FunctionTest(
      fn0: () => Int = () => 5,
      fn1: OptionalParam[Double => String] = (d: Double) => s"$d x")
    : js.Object = {
    val p = FunctionObjectMacro()
    p
  }
